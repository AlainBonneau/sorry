        ...
        <div class="letter">
          <div class="letter-background">
            <div class="letter-text">
              <p>
                ฉันอยากจะบอกว่าฉันขอโทษจริงๆ. แม้เรื่องราวในอดีตจะไม่ดีนัก
                แต่ฉันรู้ว่าตอนนั้นฉันไม่ได้อยู่ในช่วงที่ดีที่สุดของตัวเอง
                แต่ตอนนี้ฉันดีขึ้นแล้ว และ...ฉันคิดถึงคุณมาก
                ฉันสร้างเว็บไซต์นี้ขึ้นเนื่องจากเป็นวิธีของฉันในการบอกว่า
                "ฉันขอโทษ" และฉันต้องการเป็นเพื่อนกับคุณอีกครั้ง เช่นเคย
                ฉันยังคงคิดถึงช่วงเวลาที่เราเล่นเกมด้วยกันในตอนเย็นบน Discord
                มันเป็นช่วงเวลาที่เรียบง่าย แต่มันมีความหมายมากสำหรับฉัน
                ฉันเข้าใจความแตกต่างทางวัฒนธรรมระหว่างประเทศไทยและฝรั่งเศส
                สิ่งนี้อาจทำให้การสื่อสารของเรายากขึ้น
                และมันอาจจะทำให้เกิดปัญหาที่ผมไม่เข้าใจในเวลานั้นได้
                มีสิ่งหนึ่งที่เธอพูด... "ฉันไม่อยากเสียเธอไปอีกแล้ว"
                คำพูดเหล่านี้ทำให้ฉันมีความสุขจริงๆ
                และครั้งนี้...ฉันคือคนที่ไม่อยากสูญเสียคุณไป
                หากฉันมีโอกาสอีกครั้ง ฉันสัญญาว่าจะเป็นเพื่อนที่ดีกว่านี้
                ฉันเข้าใจถ้าคุณไม่อยากคุยกับฉันอีกแล้ว
                และฉันขอโทษที่ทุกอย่างต้องจบลงแบบนี้
                หากคุณรู้สึกว่าคุณไม่อยากกลับมา ฉันจะไม่โกรธเลย
                ฉันแค่ถาม...คุณช่วยเขียนคำตอบของคุณในกล่องข้อความด้านล่างนี้ได้ไหม?
                เพื่อให้ฉันสามารถเข้าใจ ยอมรับ และก้าวต่อไปได้
                สำหรับฉัน...ประตูจะเปิดให้คุณเสมอ ฉันขอให้คุณมีแต่สิ่งดีๆในชีวิต
                และถ้าคุณต้องการให้ฉันออกไปจากชีวิตของคุณฉันก็จะทำ
                แต่...ฉันต้องการคำตอบจากคุณจริงๆ
              </p>

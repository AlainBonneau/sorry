        ...
        <div class="letter">
          <div class="letter-background">
            <div class="letter-text">
              <p>
                ฉันไม่รู้ว่าคุณจะกลับมาอ่านข้อความนี้อีกไหม
                แต่ฉันอยากให้คุณรู้ว่า...ฉันผิดหวังในตัวคุณมาก
                ฉันไม่เคยคิดเลยว่าคุณจะทำแบบนี้ได้
                คุณเอาชื่อจริงของฉันและเรื่องของเราพูดกับหลายคนที่ฉันไม่รู้จักเลย
                และยังไม่รวมถึงการที่คุณตอบว่า “ใช่” แทนที่จะบอก “ไม่” ตรงๆ
                ซึ่งทำให้ฉันต้องมานั่งหวัง จริง ๆ แล้ว
                ฉันเริ่มสงสัยแล้วว่าคุณเป็นคนดีจริง ๆ
                หรือแค่เล่นบทบาทอะไรบางอย่าง คุณบอกว่าเราเป็นเพื่อนกัน
                แต่เพื่อนแบบไหนกันที่ทำแบบนี้ได้? เวลาที่ฉันอยู่ตรงหน้าคุณ
                คุณยังไม่แม้แต่จะพูดอะไรกับฉันเลย ถ้าคุณกล้าพูดตั้งแต่แรก
                ปัญหานี้ก็คงจบไปนานแล้ว
                แต่คุณเลือกที่จะปล่อยให้ฉันอยู่ในความไม่ชัดเจน ไม่พูดอะไรเลย
                ทั้งหมดนี้...แค่อยากบอกว่า ฉันไม่เข้าใจคุณเลยจริง ๆ
                และฉันจะยังคงรอ จนกว่าฉันจะได้รับคำตอบที่จริงจังจากคุณ
                เพราะฉันไม่สมควรถูกปฏิบัติอย่างเลวร้ายแบบที่คุณทำกับฉัน
              </p>

        ...
        <div class="letter">
          <div class="letter-background">
            <div class="letter-text">
              ...
              <p>
                แต่เพื่อนฉันบอกฉันว่าคุณบอกว่าจะคุยกับฉันเพื่อให้ฉันพอใจ
                แต่ในความเป็นจริงคุณพูดอย่างนั้นโดยไม่ได้หมายความอย่างนั้นจริงๆ
                ฉันอยากทราบจริงๆ ว่าคุณพูดความจริงหรือเปล่า...
                ว่าฉันควรจะรอให้คุณส่งข้อความมาหาฉันหรือเปล่า
                ฉันเต็มใจที่จะอดทนหากนั่นคือสิ่งที่คุณต้องการ
                แต่ฉันแค่อยากรู้ว่าวันหนึ่งคุณจะติดต่อฉันจริงหรือไม่
                ฉันไม่ต้องการคำว่าบางทีหรือขอโทษอีกต่อไป ฉันแค่ต้องการความจริง
              </p>
              <p>

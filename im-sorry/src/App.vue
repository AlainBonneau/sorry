        ...
        <div class="letter">
          <div class="letter-background">
            <div class="letter-text">
              ...
              <p>
                ฉันรู้ว่าคุณเป็นคนดีแค่ไหน และฉันขอโทษอีกครั้งที่ทำให้คุณร้องไห้
                ฉันรู้สึกแย่มากเกี่ยวกับเรื่องนี้
                ฉันหวังว่าวันหนึ่งเราจะสามารถเป็นเพื่อนแท้ได้
                นั่นคือสิ่งที่ฉันหวังอย่างจริงใจ แม้ว่าบางครั้งจะเจ็บปวด
                แต่ฉันก็ดีใจมากที่ได้พบคุณ
                ฉันผูกพันกับคุณอย่างจริงใจในฐานะเพื่อน
                ฉันไม่รู้ว่าทำไมฉันถึงรู้สึกผูกพันกับคุณแบบนี้
                นี่เป็นครั้งแรกที่ฉันรู้สึกแบบนี้กับเพื่อนคนหนึ่ง
                แต่ฉันอยากให้คุณมั่นใจว่าฉันไม่มีความรู้สึกแบบโรแมนติก
                ฉันแค่รู้สึกว่าคุณเป็นเพื่อนที่มีความหมายสำหรับฉันจริงๆ
                บางทีอาจเป็นเพราะว่านี่เป็นครั้งแรกที่ฉันได้เจอคนดีๆ อย่างคุณ

        ...
        <div class="letter">
          <div class="letter-background">
            <div class="letter-text">
              <p>
                ขอบคุณสำหรับทุกอย่างนะมินนี่
                ถ้าวันหนึ่งคุณอยากกลับมาคุยกับฉันอีก คุณสามารถปลดบล็อก
                <a href="https://www.instagram.com/alaindev97/" target="_blank"
                  >Instagram</a
                >
                ของฉันได้เลย แต่ถ้าคุณไม่ต้องการ ฉันก็ไม่โกรธคุณนะ
                และขอให้คุณพบเจอแต่สิ่งที่ดีที่สุดในชีวิต
              </p>

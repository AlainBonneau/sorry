        ...
        <div class="letter">
          <div class="letter-background">
            <div class="letter-text">
              <p>
                ขอบคุณมากที่คุณกล้าที่จะบอกฉันว่าคุณรู้สึกอย่างไร
                ตอนนี้ฉันเข้าใจทุกอย่างแล้ว แล้วฉันไม่ได้โกรธเลย ฉันขอโทษจริงๆ
                ที่สิ่งที่ฉันพูดเมื่อตอนนั้นทำให้คุณเจ็บปวด
                มันไม่ใช่สิ่งที่ฉันได้วางแผนไว้เลย
                ฉันพูดแบบนั้นเพราะฉันรู้สึกเจ็บปวดและสับสน
                ขอบคุณที่ยังมองเห็นความพยายามของฉัน
                ฉันจะไม่รบกวนคุณอีกต่อไปและฉันจะให้เวลาที่คุณต้องการ
                ไม่ต้องกังวล. ฉันจะไม่โทษคุณ แล้วฉันจะไม่คิดร้ายต่อคุณ
                แม้ว่าการรอคอยจะเจ็บปวด แต่ฉันจะทำเพราะคุณต้องการมัน ค่อยๆทำไป
                ฉันจะรอจนกว่าคุณจะพร้อม ดูแลตัวเองดีๆ นะ
              </p>
              <p>
                ฉันรู้ว่าคุณเก่งขนาดไหน และฉันยังขอโทษที่ทำให้คุณร้องไห้
                ฉันรู้สึกแย่มากเกี่ยวกับเรื่องนี้
                ฉันหวังว่าวันหนึ่งเราจะสามารถเป็นเพื่อนแท้กันได้
                นั่นคือสิ่งที่ฉันหวังอย่างจริงใจ ถึงแม้บางครั้งจะเจ็บปวดก็ตาม
                แต่ฉันก็ดีใจมากที่ได้พบคุณ
                ฉันผูกพันกับคุณอย่างจริงใจในฐานะเพื่อน
                ฉันไม่รู้ว่าทำไมฉันถึงรู้สึกผูกพันกับคุณมากขนาดนี้
                นี่เป็นครั้งแรกที่ฉันรู้สึกแบบนี้กับเพื่อนที่อยู่ห่างไกล
                แต่ฉันต้องการให้คุณแน่ใจว่าฉันไม่มีความรู้สึกโรแมนติกใดๆ
                ฉันแค่รู้สึกว่าคุณเป็นเพื่อนที่มีความหมายต่อฉันจริงๆ
                บางทีอาจเป็นเพราะนี่เป็นครั้งแรกที่ฉันได้พบคนใจดีเหมือนคุณ
                ขอบคุณนะคะมินนี่ ฉันจะพยายามเป็นคนดีขึ้น
                นี่เป็นความรู้สึกของฉันตอนนี้
                ฉันหวังว่าสิ่งนั้นคงไม่ทำให้คุณกลัว
                (ฉันรู้ว่าบางคนไม่ชอบมีมิตรภาพที่แน่นแฟ้น)
              </p>
